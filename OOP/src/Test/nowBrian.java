...
class nowBrain extends Frame implements ActionListener{
  Button b0,b1,b2,b3,b4,b5,b6,b7,b8,b9,bAdd,bMin,bMult,bDiv,bEqu,bClear,bDecPoint;
  ...
  public nowBrain()	
  {
         ...
         bDecPoint = new Button(".");
         name=new TextField(10);
         greeting=new TextField(15);
         Panel pnl = new Panel();
         Panel pnl2= new Panel();
         pnl.setLayout(new GridLayout(5,5,10,10));
  ...
  public void actionPerformed(ActionEvent e){
         ...
         {	
        	 ...
        	 if (n.length() == 2)
        	 	...
        	 	{
        		 num2 = (Character.getNumericValue(n.charAt(1)) * 10) + Character.getNumericValue(n.charAt(2));;
        	 	}
